...
//  Netflix
//
//  Created by Владислав Калинин on 03.12.2022.
//
...
// MARK: - PROPERTY
    ...
    public let searchResultsCollecitonView: UICollectionView = {
...
// MARK: - LIFECYCLE
    ...
    override func viewDidLoad() {
        ...
        searchResultsCollecitonView.delegate = self
        searchResultsCollecitonView.dataSource = self
